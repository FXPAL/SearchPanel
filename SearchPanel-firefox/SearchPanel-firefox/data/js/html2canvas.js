...
_html2canvas.Renderer.Canvas = function(options) {
  ...
  function safeImage(item) {
	...
	try {
		// problem was a TypeError when executing this part in a chrome extension,
		// this patch uses the jquery's HTML creator... somehow this works with chrome extensions perfectly!!!
		var a = $('<img>');
		
		a.attr('src',item['arguments'][0].src);
		testctx.drawImage(a[0], 0, 0);
		testctx.getImageData(0, 0, 1, 1);
    		
		item['arguments'][0] = a[0];
    		//a.src = item['arguments'][0].src;
      } catch(e) {
    	  console.log('fail',e);
